...
typedef enum
{
    CY_I2S_ROUTE_TX_IN_DRIVEN_BY_IOSS_TX_IN = 0U, /**< TX slave signaling indipendent from RX signaling. */
    CY_I2S_ROUTE_TX_IN_DRIVEN_BY_IOSS_RX_IN = 1U, /**< TX slave signalling inputs driven by RX Slave. */
    CY_I2S_ROUTE_TX_IN_DRIVEN_BY_RX_OUT     = 2U, /**< TX slave signalling inputs driven by RX Master. */
} cy_en_i2s_route_control_t;
...
typedef struct
{
    ...
    cy_en_i2s_route_control_t       txRouteControl;         /**< Controls routing to the TX slave signalling inputs (FSYNC/SCK). */
    ...
    cy_en_i2s_route_control_t       rxRouteControl;         /**< Controls routing to the RX slave signalling inputs (FSYNC/SCK). */
