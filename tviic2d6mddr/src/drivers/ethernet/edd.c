...
/*	// Only Four Queues are supported
...
#define CEDI_CLEAR_ALL_RDCLR_INT(Q)  if (CEDI_PdVar(numQs)>Q) \
        reg = CPS_UncachedRead32(CEDI_RegAddr(int_q##Q##_status));
...
*/
        ...
        reg = CPS_UncachedRead32(CEDI_RegAddr(int_status));
...
static void initAllRegs(void *pD)
{
    ...
    CPS_UncachedWrite32(CEDI_RegAddr(network_config), 0);    CPS_UncachedWrite32(CEDI_RegAddr(user_io_register), 0);
    ...
    CPS_UncachedWrite32(CEDI_RegAddr(jumbo_max_length), 0x00002800);    CPS_UncachedWrite32(CEDI_RegAddr(external_fifo_interface), 0);
    CPS_UncachedWrite32(CEDI_RegAddr(axi_max_pipeline), 0x00000101);    CPS_UncachedWrite32(CEDI_RegAddr(rsc_control), 0);
    ...
    CPS_UncachedWrite32(CEDI_RegAddr(wol_register), 0);    CPS_UncachedWrite32(CEDI_RegAddr(stretch_ratio), 0);
    ...
    CPS_UncachedWrite32(CEDI_RegAddr(tx_ptp_unicast), 0);    CPS_UncachedWrite32(CEDI_RegAddr(tsu_nsec_cmp), 0);
    CPS_UncachedWrite32(CEDI_RegAddr(tsu_sec_cmp), 0);
    CPS_UncachedWrite32(CEDI_RegAddr(tsu_msb_sec_cmp), 0);
    CPS_UncachedWrite32(CEDI_RegAddr(dpram_fill_dbg), 0);    CPS_UncachedWrite32(CEDI_RegAddr(pcs_control), 0);
    ...
    CPS_UncachedWrite32(CEDI_RegAddr(dpram_fill_dbg), 0);    CPS_UncachedWrite32(CEDI_RegAddr(cbs_control), 0);
