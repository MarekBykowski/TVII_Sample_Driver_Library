/**********************************************************************
 * Copyright (C) 2013-2015 Cadence Design Systems, Inc.
...
/**
* \defgroup group_ethif Ethernet Interface (ETHIF)
* \{
* This driver provides global ETHIF defines and API function definitions.
*
* \defgroup group_ethif_macros Macro
 ...
 * Enumerations
 **********************************************************************/
/** \addtogroup group_ethif_enums Dynamic Data Structures This section defines the data structures used by the driver to provide hardware information, modification, and dynamic operation of the driver. These data structures are defined in the header file of the core driver and utilized by the API. @{ */
typedef enum
{
