...
{       
    for(uint8_t data_i = 0; data_i <63; data_i++)
    {
        Cy_I2S_WriteTxData(&CY_AUDIOSS_I2S_TYPE->I2S_TX_STRUCT, i2sTransmitData[data_i]);
    }
...
{   
    ...
    for(uint8_t data_i = 0; data_i <noOfReceivedBytes; data_i++)
    {
        receivedData[data_i] = Cy_I2S_ReadRxData(&CY_AUDIOSS_I2S_TYPE->I2S_RX_STRUCT);
    }
...
void AudioSSInterruptHandler(void)
{
    ...
    {
        //Cy_I2S_ClearTxInterrupt(&CY_AUDIOSS_I2S_TYPE->I2S_TX_STRUCT, maskedIntrStatus);
