...
#define TCPWMx_GRPx_CNTx_CAPTURE           TCPWM0_GRP2_CNT17
#define PCLK_TCPWMx_CLOCKSx_CAPTURE        PCLK_TCPWM0_CLOCKS529
...
#define TCPWMx_TR_ONE_CNT_INx_MUX          P7_5_TCPWM0_TR_ONE_CNT_IN529

/* PWM Configuration definitions */
#define TCPWMx_GRPx_CNTx_PWM               TCPWM0_GRP1_CNT2
#define PCLK_TCPWMx_CLOCKSx_PWM            PCLK_TCPWM0_CLOCKS258

/* TCPWM0_LINE1 */
#define TCPWMx_LINEx_PORT                  GPIO_PRT7
#define TCPWMx_LINEx_PIN                   4u
#define TCPWMx_LINEx_MUX                   P7_4_TCPWM0_LINE258
...
{
    .sysIntSrc  = tcpwm_0_interrupts_529_IRQn,
