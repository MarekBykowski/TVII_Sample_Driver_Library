...
#define TCPWMx_GRPx_CNTx_PWM_DT           TCPWM0_GRP1_CNT2
#define PCLK_TCPWMx_CLOCKSx_PWM_DT        PCLK_TCPWM0_CLOCKS258
...
#define TCPWMx_LINE_CMPLx_PIN  5u
#define TCPWMx_LINE_CMPLx_MUX  P7_5_TCPWM0_LINE_COMPL258
