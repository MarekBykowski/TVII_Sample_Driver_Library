...
#ifndef LPDDR4_CFG3_ECC_H_INCLUDED
#define LPDDR4_CFG3_ECC_H_INCLUDED
...
{ 
    ...
    .unDMCFG.stcField = {
        ...
        .u1INT_GC_FSM_CLR = CY_LPDDR4_DMCFG_INT_GC_FSM_CLR_DONT_CLEAR,      /*  Global FSM Error interrupt clear signal. 0: Disable (Default). 1: Clear.
                                                                                Set int_gc_fsm LOW. */
        .u1INT_ECC_EN = CY_LPDDR4_ONOFF_ENABLE,                             /*  Enable the ECC internupts*/   
        ...
        .u1INLINE_ECC_EN = CY_LPDDR4_ONOFF_ENABLE                          /*  enable/disable inline ecc */
    },
...
#endif // LPDDR4_CFG3_ECC_H_INCLUDED
