...
#ifndef LPDDR4_CFG7_H_INCLUDED
#define LPDDR4_CFG7_H_INCLUDED
...
{ 
    ...
    .unRTCFG0_RT1.stcField = 
    {
        #if (HEADER_FILE_RELEASE > DOTP26)
        /* Bitfields added with release p27*/
        .u1ARQ_LAHEAD_EN = CY_LPDDR4_ONOFF_DISABLE,              /* Out of order enable for Look-ahead buffer in read channel - Route 1 */
    ...
    .unRTCFG0_RT2.stcField = 
    {
        #if (HEADER_FILE_RELEASE > DOTP26)
        /* Bitfields added with release p27*/
        .u1ARQ_LAHEAD_EN = CY_LPDDR4_ONOFF_DISABLE,              /* Out of order enable for Look-ahead buffer in read channel - Route 2 */
    ...
    .unRTCFG0_RT3.stcField = 
    {
        ...
        .u4AWQ_LVL_LO = 0x4,                                    /* Denotes Write Address Queue Low Priority Threshold */
        .u1ARQ_LAT_BARRIER_EN = CY_LPDDR4_ONOFF_DISABLE,         /* Maximum Latency Barrier Enable for Read Channel */
        .u1AWQ_LAT_BARRIER_EN = CY_LPDDR4_ONOFF_ENABLE,         /* Maximum Latency Barrier Enable for Write Channel */
        .u1ARQ_OOO_EN = CY_LPDDR4_ONOFF_ENABLE,                 /* Read Address Queue Operation Mode */
        .u1AWQ_OOO_EN = CY_LPDDR4_ONOFF_ENABLE,                 /* Write Address Queue Operation Mode  */
        .u1ACQ_REALTIME_EN = CY_LPDDR4_ONOFF_ENABLE,            /* Realtime priority enable for Read/Write */
        .u1WM_ENABLE = CY_LPDDR4_ONOFF_ENABLE                   /* Masked Write Support Enable */
    ...
    {
        .u8ARQ_LAT_BARRIER = 0x1B,          /* Maximum Latency Barrier for Read Channel */
        .u8AWQ_LAT_BARRIER = 0x1E,          /* Maximum Latency Barrier for Write Channel */
        .u8ARQ_STARV_TH = 0x5,             /* Denotes Read Address Queue Threshold for starvation preventing. Its 
                                               value represents the number of hits in a hit chain */
        .u8AWQ_STARV_TH = 0x6              /* Denotes Write Address Queue Threshold for starvation preventing. Its 
                                               value represents the number of hits in a hit chain */
    },
    ...
    .unRTCFG1_RT1.stcField = 
    {
        .u8ARQ_LAT_BARRIER = 0x1B,          /* Maximum Latency Barrier for Read Channel */
        .u8AWQ_LAT_BARRIER = 0x1E,          /* Maximum Latency Barrier for Write Channel */
        .u8ARQ_STARV_TH = 0x5,             /* Denotes Write Address Queue Threshold for starvation preventing. Its 
                                               value represents the number of hits in a hit chain */
        .u8AWQ_STARV_TH = 0x6              /* Denotes Write Address Queue Threshold for starvation preventing. Its 
                                               value represents the number of hits in a hit chain */
    },
