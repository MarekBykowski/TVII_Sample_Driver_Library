/***************************************************************************//**
* \file gpio_tviic2d6mddr_500_bga.h
*
* \brief
* TVIIC2D6MDDR device GPIO header for 500-BGA package
*
* \note
...
#ifndef _GPIO_TVIIC2D6MDDR_500_BGA_H_
#define _GPIO_TVIIC2D6MDDR_500_BGA_H_
...
typedef enum
{
    ...
    AMUX_SPLIT_CTL_5                = 0x0005u,  /* Left = AMUXBUS_LPDDR4; Right = AMUXBUS_MAIN */
...
typedef enum
{
    ...
    P1_2_PERI_TR_IO_INPUT0          = 21,       /* Digital Active - peri.tr_io_input[0]:0 */
    ...
    P9_0_VIDEOSS0_TTL_CAP0_DATA23   = 11,       /* Digital Active - videoss[0].ttl_cap0_data[23]:0 */
    P9_0_TDM0_TDM_RX_MCK2           = 17,       /* Digital Active - tdm[0].tdm_rx_mck[2]:0 */
    P9_0_VIDEOSS0_TTL_DSP1_DATA_A111 = 18,      /* Digital Active - videoss[0].ttl_dsp1_data_a1[11]:0 */
    P9_0_SCB1_SPI_CLK               = 19,       /* Digital Active - scb[1].spi_clk:0 */
    P9_0_SCB1_UART_RX               = 20,       /* Digital Active - scb[1].uart_rx:0 */
    ...
    P9_1_VIDEOSS0_TTL_CAP0_DATA22   = 11,       /* Digital Active - videoss[0].ttl_cap0_data[22]:0 */
    P9_1_TDM0_TDM_RX_SCK2           = 17,       /* Digital Active - tdm[0].tdm_rx_sck[2]:0 */
    P9_1_VIDEOSS0_TTL_DSP1_DATA_A011 = 18,      /* Digital Active - videoss[0].ttl_dsp1_data_a0[11]:0 */
    P9_1_SCB1_SPI_MOSI              = 19,       /* Digital Active - scb[1].spi_mosi:0 */
    P9_1_SCB1_UART_TX               = 20,       /* Digital Active - scb[1].uart_tx:0 */
    ...
    P9_2_VIDEOSS0_TTL_CAP0_DATA21   = 11,       /* Digital Active - videoss[0].ttl_cap0_data[21]:0 */
    P9_2_TDM0_TDM_RX_FSYNC2         = 17,       /* Digital Active - tdm[0].tdm_rx_fsync[2]:0 */
    P9_2_VIDEOSS0_TTL_DSP1_DATA_A110 = 18,      /* Digital Active - videoss[0].ttl_dsp1_data_a1[10]:0 */
    P9_2_SCB1_SPI_MISO              = 19,       /* Digital Active - scb[1].spi_miso:0 */
    P9_2_SCB1_UART_RTS              = 20,       /* Digital Active - scb[1].uart_rts:0 */
    ...
    P9_3_VIDEOSS0_TTL_CAP0_DATA20   = 11,       /* Digital Active - videoss[0].ttl_cap0_data[20]:0 */
    P9_3_TDM0_TDM_RX_SD2            = 17,       /* Digital Active - tdm[0].tdm_rx_sd[2]:0 */
    P9_3_VIDEOSS0_TTL_DSP1_DATA_A010 = 18,      /* Digital Active - videoss[0].ttl_dsp1_data_a0[10]:0 */
    P9_3_SCB1_SPI_SELECT0           = 19,       /* Digital Active - scb[1].spi_select0:0 */
    P9_3_SCB1_UART_CTS              = 20,       /* Digital Active - scb[1].uart_cts:0 */
    ...
    P9_4_VIDEOSS0_TTL_CAP0_DATA18   = 11,       /* Digital Active - videoss[0].ttl_cap0_data[18]:0 */
    P9_4_TDM0_TDM_TX_MCK0           = 16,       /* Digital Active - tdm[0].tdm_tx_mck[0]:0 */
    P9_4_TDM0_TDM_RX_MCK1           = 17,       /* Digital Active - tdm[0].tdm_rx_mck[1]:1 */
    P9_4_VIDEOSS0_TTL_DSP1_DATA_A19 = 18,       /* Digital Active - videoss[0].ttl_dsp1_data_a1[9]:0 */
    P9_4_SCB1_SPI_SELECT1           = 19,       /* Digital Active - scb[1].spi_select1:0 */
    P9_4_PWM0_PWM_LINE1_P0          = 21,       /* Digital Active - pwm[0].pwm_line1_p[0]:0 */
    P9_4_SG0_SG_TONE0               = 22,       /* Digital Active - sg[0].sg_tone[0]:0 */
    P9_4_VIDEOSS0_TTL_CAP0_DATA9    = 23,       /* Digital Active - videoss[0].ttl_cap0_data[9]:1 */
    ...
    P9_5_VIDEOSS0_TTL_CAP0_DATA17   = 11,       /* Digital Active - videoss[0].ttl_cap0_data[17]:0 */
    P9_5_TDM0_TDM_TX_SCK0           = 16,       /* Digital Active - tdm[0].tdm_tx_sck[0]:0 */
    P9_5_TDM0_TDM_RX_SCK1           = 17,       /* Digital Active - tdm[0].tdm_rx_sck[1]:1 */
    P9_5_VIDEOSS0_TTL_DSP1_DATA_A09 = 18,       /* Digital Active - videoss[0].ttl_dsp1_data_a0[9]:0 */
    P9_5_PWM0_PWM_LINE1_N0          = 21,       /* Digital Active - pwm[0].pwm_line1_n[0]:0 */
    P9_5_SG0_SG_AMPL0               = 22,       /* Digital Active - sg[0].sg_ampl[0]:0 */
    P9_5_VIDEOSS0_TTL_CAP0_DATA8    = 23,       /* Digital Active - videoss[0].ttl_cap0_data[8]:1 */
    P9_5_ETH0_MDIO                  = 27,       /* Digital Active - eth[0].mdio:1 */
    ...
    P9_6_VIDEOSS0_TTL_CAP0_DATA16   = 11,       /* Digital Active - videoss[0].ttl_cap0_data[16]:0 */
    P9_6_TDM0_TDM_TX_FSYNC0         = 16,       /* Digital Active - tdm[0].tdm_tx_fsync[0]:0 */
    P9_6_TDM0_TDM_RX_FSYNC1         = 17,       /* Digital Active - tdm[0].tdm_rx_fsync[1]:1 */
    P9_6_VIDEOSS0_TTL_DSP1_DATA_A18 = 18,       /* Digital Active - videoss[0].ttl_dsp1_data_a1[8]:0 */
    P9_6_PWM0_PWM_LINE2_P0          = 21,       /* Digital Active - pwm[0].pwm_line2_p[0]:0 */
    P9_6_SG0_SG_TONE1               = 22,       /* Digital Active - sg[0].sg_tone[1]:0 */
    P9_6_VIDEOSS0_TTL_CAP0_DATA7    = 23,       /* Digital Active - videoss[0].ttl_cap0_data[7]:1 */

    /* P9.7 */
    P9_7_GPIO                       =  0,       /* GPIO controls 'out' */
    P9_7_AMUXA                      =  4,       /* Analog mux bus A */
    P9_7_AMUXB                      =  5,       /* Analog mux bus B */
    P9_7_VIDEOSS0_TTL_CAP0_DATA19   = 11,       /* Digital Active - videoss[0].ttl_cap0_data[19]:0 */
    P9_7_SCB2_I2C_SDA               = 17,       /* Digital Active - scb[2].i2c_sda:0 */
    P9_7_VIDEOSS0_TTL_DSP1_CONTROL8 = 18,       /* Digital Active - videoss[0].ttl_dsp1_control[8]:0 */
    P9_7_SCB2_SPI_CLK               = 19,       /* Digital Active - scb[2].spi_clk:0 */
    P9_7_SCB2_UART_RX               = 20,       /* Digital Active - scb[2].uart_rx:0 */
    P9_7_VIDEOSS0_TTL_CAP0_DATA5    = 23,       /* Digital Active - videoss[0].ttl_cap0_data[5]:2 */

    /* P10.0 */
    P10_0_GPIO                      =  0,       /* GPIO controls 'out' */
    P10_0_AMUXA                     =  4,       /* Analog mux bus A */
    P10_0_AMUXB                     =  5,       /* Analog mux bus B */
    P10_0_CPUSS_TRACE_DATA4         = 11,       /* Digital Active - cpuss.trace_data[4]:1 */
    P10_0_SCB2_I2C_SCL              = 17,       /* Digital Active - scb[2].i2c_scl:0 */
    P10_0_VIDEOSS0_TTL_DSP1_CONTROL7 = 18,      /* Digital Active - videoss[0].ttl_dsp1_control[7]:0 */
    P10_0_SCB2_SPI_MOSI             = 19,       /* Digital Active - scb[2].spi_mosi:0 */
    P10_0_SCB2_UART_TX              = 20,       /* Digital Active - scb[2].uart_tx:0 */
    P10_0_VIDEOSS0_TTL_CAP0_DATA4   = 23,       /* Digital Active - videoss[0].ttl_cap0_data[4]:2 */

    /* P10.1 */
    P10_1_GPIO                      =  0,       /* GPIO controls 'out' */
    P10_1_AMUXA                     =  4,       /* Analog mux bus A */
    P10_1_AMUXB                     =  5,       /* Analog mux bus B */
    P10_1_CPUSS_TRACE_DATA5         = 11,       /* Digital Active - cpuss.trace_data[5]:1 */
    P10_1_VIDEOSS0_TTL_DSP1_CONTROL6 = 18,      /* Digital Active - videoss[0].ttl_dsp1_control[6]:0 */
    P10_1_SRSS_EXT_CLK              = 19,       /* Digital Active - srss.ext_clk:2 */
    P10_1_VIDEOSS0_TTL_CAP0_DATA6   = 23,       /* Digital Active - videoss[0].ttl_cap0_data[6]:1 */

    /* P10.2 */
    P10_2_GPIO                      =  0,       /* GPIO controls 'out' */
    P10_2_AMUXA                     =  4,       /* Analog mux bus A */
    P10_2_AMUXB                     =  5,       /* Analog mux bus B */
    P10_2_CPUSS_TRACE_DATA6         = 16,       /* Digital Active - cpuss.trace_data[6]:1 */
    P10_2_VIDEOSS0_TTL_DSP1_CONTROL5 = 18,      /* Digital Active - videoss[0].ttl_dsp1_control[5]:0 */
    P10_2_SCB2_SPI_SELECT1          = 19,       /* Digital Active - scb[2].spi_select1:0 */
    P10_2_PWM0_PWM_MCK0             = 21,       /* Digital Active - pwm[0].pwm_mck[0]:0 */
    P10_2_VIDEOSS0_TTL_CAP0_DATA3   = 23,       /* Digital Active - videoss[0].ttl_cap0_data[3]:2 */

    /* P10.3 */
    P10_3_GPIO                      =  0,       /* GPIO controls 'out' */
    P10_3_AMUXA                     =  4,       /* Analog mux bus A */
    P10_3_AMUXB                     =  5,       /* Analog mux bus B */
    P10_3_CPUSS_TRACE_DATA7         = 16,       /* Digital Active - cpuss.trace_data[7]:1 */
    P10_3_VIDEOSS0_TTL_DSP1_CONTROL4 = 18,      /* Digital Active - videoss[0].ttl_dsp1_control[4]:0 */
    P10_3_SCB2_SPI_MISO             = 19,       /* Digital Active - scb[2].spi_miso:0 */
    P10_3_SCB2_UART_RTS             = 20,       /* Digital Active - scb[2].uart_rts:0 */
    P10_3_PWM0_PWM_MCK1             = 21,       /* Digital Active - pwm[0].pwm_mck[1]:0 */
    P10_3_VIDEOSS0_TTL_CAP0_DATA2   = 23,       /* Digital Active - videoss[0].ttl_cap0_data[2]:2 */
    ...
    P10_4_VIDEOSS0_TTL_CAP0_DATA15  = 11,       /* Digital Active - videoss[0].ttl_cap0_data[15]:0 */
    P10_4_TDM0_TDM_TX_SD0           = 16,       /* Digital Active - tdm[0].tdm_tx_sd[0]:0 */
    P10_4_TDM0_TDM_RX_SD1           = 17,       /* Digital Active - tdm[0].tdm_rx_sd[1]:1 */
    P10_4_VIDEOSS0_TTL_DSP1_DATA_A08 = 18,      /* Digital Active - videoss[0].ttl_dsp1_data_a0[8]:0 */
    P10_4_CPUSS_TRACE_CLOCK         = 19,       /* Digital Active - cpuss.trace_clock:1 */
    P10_4_PWM0_PWM_LINE2_N0         = 21,       /* Digital Active - pwm[0].pwm_line2_n[0]:0 */
    P10_4_SG0_SG_AMPL1              = 22,       /* Digital Active - sg[0].sg_ampl[1]:0 */
    P10_4_VIDEOSS0_TTL_CAP0_DATA5   = 23,       /* Digital Active - videoss[0].ttl_cap0_data[5]:1 */

    /* P10.5 */
    P10_5_GPIO                      =  0,       /* GPIO controls 'out' */
    P10_5_AMUXA                     =  4,       /* Analog mux bus A */
    P10_5_AMUXB                     =  5,       /* Analog mux bus B */
    P10_5_VIDEOSS0_TTL_CAP0_DATA14  = 11,       /* Digital Active - videoss[0].ttl_cap0_data[14]:0 */
    P10_5_TDM0_TDM_TX_MCK1          = 16,       /* Digital Active - tdm[0].tdm_tx_mck[1]:0 */
    P10_5_TDM0_TDM_RX_MCK0          = 17,       /* Digital Active - tdm[0].tdm_rx_mck[0]:1 */
    P10_5_VIDEOSS0_TTL_DSP1_DATA_A17 = 18,      /* Digital Active - videoss[0].ttl_dsp1_data_a1[7]:0 */
    P10_5_CPUSS_TRACE_DATA0         = 19,       /* Digital Active - cpuss.trace_data[0]:1 */
    P10_5_PWM0_PWM_LINE1_P1         = 21,       /* Digital Active - pwm[0].pwm_line1_p[1]:0 */
    P10_5_SG0_SG_TONE2              = 22,       /* Digital Active - sg[0].sg_tone[2]:0 */
    P10_5_VIDEOSS0_TTL_CAP0_DATA4   = 23,       /* Digital Active - videoss[0].ttl_cap0_data[4]:1 */

    /* P10.6 */
    P10_6_GPIO                      =  0,       /* GPIO controls 'out' */
    P10_6_AMUXA                     =  4,       /* Analog mux bus A */
    P10_6_AMUXB                     =  5,       /* Analog mux bus B */
    P10_6_VIDEOSS0_TTL_CAP0_DATA13  = 11,       /* Digital Active - videoss[0].ttl_cap0_data[13]:0 */
    P10_6_TDM0_TDM_TX_SCK1          = 16,       /* Digital Active - tdm[0].tdm_tx_sck[1]:0 */
    P10_6_TDM0_TDM_RX_SCK0          = 17,       /* Digital Active - tdm[0].tdm_rx_sck[0]:1 */
    P10_6_VIDEOSS0_TTL_DSP1_DATA_A07 = 18,      /* Digital Active - videoss[0].ttl_dsp1_data_a0[7]:0 */
    P10_6_CPUSS_TRACE_DATA1         = 19,       /* Digital Active - cpuss.trace_data[1]:1 */
    P10_6_PWM0_PWM_LINE1_N1         = 21,       /* Digital Active - pwm[0].pwm_line1_n[1]:0 */
    P10_6_SG0_SG_AMPL2              = 22,       /* Digital Active - sg[0].sg_ampl[2]:0 */
    P10_6_VIDEOSS0_TTL_CAP0_DATA3   = 23,       /* Digital Active - videoss[0].ttl_cap0_data[3]:1 */

    /* P10.7 */
    P10_7_GPIO                      =  0,       /* GPIO controls 'out' */
    P10_7_AMUXA                     =  4,       /* Analog mux bus A */
    P10_7_AMUXB                     =  5,       /* Analog mux bus B */
    P10_7_VIDEOSS0_TTL_DSP1_CONTROL3 = 18,      /* Digital Active - videoss[0].ttl_dsp1_control[3]:0 */
    P10_7_SCB2_SPI_SELECT0          = 19,       /* Digital Active - scb[2].spi_select0:0 */
    P10_7_SCB2_UART_CTS             = 20,       /* Digital Active - scb[2].uart_cts:0 */
    P10_7_VIDEOSS0_TTL_CAP0_CLK     = 23,       /* Digital Active - videoss[0].ttl_cap0_clk:2 */
    ...
    P11_0_VIDEOSS0_TTL_CAP0_DATA12  = 11,       /* Digital Active - videoss[0].ttl_cap0_data[12]:0 */
    ...
    P11_0_CPUSS_TRACE_DATA2         = 19,       /* Digital Active - cpuss.trace_data[2]:1 */
    ...
    P11_1_CPUSS_TRACE_DATA3         = 19,       /* Digital Active - cpuss.trace_data[3]:1 */
    ...
    P11_2_SDHC0_CARD_DAT_3TO01      = 11,       /* Digital Active - sdhc[0].card_dat_3to0[1]:1 */
    ...
    P11_3_SDHC0_CARD_DAT_3TO02      = 11,       /* Digital Active - sdhc[0].card_dat_3to0[2]:1 */
    ...
    P11_4_SDHC0_CARD_DAT_3TO03      = 11,       /* Digital Active - sdhc[0].card_dat_3to0[3]:1 */
    P11_4_CPUSS_TRACE_DATA6         = 16,       /* Digital Active - cpuss.trace_data[6]:0 */
    ...
    P11_5_SDHC0_CARD_DAT_7TO40      = 11,       /* Digital Active - sdhc[0].card_dat_7to4[0]:1 */
    P11_5_CPUSS_TRACE_DATA7         = 16,       /* Digital Active - cpuss.trace_data[7]:0 */
    ...
    P11_6_SDHC0_CARD_DAT_7TO41      = 11,       /* Digital Active - sdhc[0].card_dat_7to4[1]:1 */
    P11_6_TDM0_TDM_RX_MCK1          = 17,       /* Digital Active - tdm[0].tdm_rx_mck[1]:2 */
    P11_6_CPUSS_TRACE_CLOCK         = 19,       /* Digital Active - cpuss.trace_clock:0 */
    ...
    P11_7_SDHC0_CARD_DAT_7TO42      = 11,       /* Digital Active - sdhc[0].card_dat_7to4[2]:1 */
    P11_7_TDM0_TDM_RX_SCK1          = 17,       /* Digital Active - tdm[0].tdm_rx_sck[1]:2 */
    P11_7_CPUSS_TRACE_DATA0         = 19,       /* Digital Active - cpuss.trace_data[0]:0 */
    ...
    P12_0_SDHC0_CARD_DAT_7TO43      = 11,       /* Digital Active - sdhc[0].card_dat_7to4[3]:1 */
    P12_0_TDM0_TDM_RX_FSYNC1        = 17,       /* Digital Active - tdm[0].tdm_rx_fsync[1]:2 */
    P12_0_CPUSS_TRACE_DATA1         = 19,       /* Digital Active - cpuss.trace_data[1]:0 */
    ...
    P12_1_SDHC0_CARD_CMD            = 11,       /* Digital Active - sdhc[0].card_cmd:1 */
    P12_1_TDM0_TDM_RX_SD1           = 17,       /* Digital Active - tdm[0].tdm_rx_sd[1]:2 */
    P12_1_CPUSS_TRACE_DATA2         = 19,       /* Digital Active - cpuss.trace_data[2]:0 */
    ...
    P12_2_SDHC0_CARD_IF_PWR_EN      = 11,       /* Digital Active - sdhc[0].card_if_pwr_en:1 */
    ...
    P12_2_CPUSS_TRACE_DATA3         = 19,       /* Digital Active - cpuss.trace_data[3]:0 */
    ...
    P12_3_SDHC0_CLK_CARD            = 11,       /* Digital Active - sdhc[0].clk_card:1 */
    ...
    P12_4_SDHC0_CARD_DAT_3TO00      = 11,       /* Digital Active - sdhc[0].card_dat_3to0[0]:1 */
    ...
    P12_5_SDHC0_CARD_DETECT_N       = 11,       /* Digital Active - sdhc[0].card_detect_n:1 */
    ...
    P12_6_SDHC0_CARD_MECH_WRITE_PROT = 11,      /* Digital Active - sdhc[0].card_mech_write_prot:1 */
    ...
    P13_0_CPUSS_TRACE_DATA4         = 11,       /* Digital Active - cpuss.trace_data[4]:0 */
    ...
    P13_1_CPUSS_TRACE_DATA5         = 11,       /* Digital Active - cpuss.trace_data[5]:0 */
    ...
    P17_0_ETH0_TXD0                 = 11,       /* Digital Active - eth[0].txd[0] */
    ...
    P17_1_ETH0_TXD1                 = 11,       /* Digital Active - eth[0].txd[1] */
    ...
    P17_2_ETH0_TX_CLK               = 11,       /* Digital Active - eth[0].tx_clk */
    ...
    P17_3_ETH0_TXD2                 = 11,       /* Digital Active - eth[0].txd[2] */
    ...
    P17_4_ETH0_TXD3                 = 11,       /* Digital Active - eth[0].txd[3] */
    ...
    P18_0_ETH0_RXD3                 = 11,       /* Digital Active - eth[0].rxd[3] */
    ...
    P18_1_ETH0_RX_CTL               = 11,       /* Digital Active - eth[0].rx_ctl */
    ...
    P19_0_ETH0_TX_CTL               = 11,       /* Digital Active - eth[0].tx_ctl */
    ...
    P19_1_ETH0_REF_CLK              = 11,       /* Digital Active - eth[0].ref_clk */
    ...
    P19_2_ETH0_RXD0                 = 11,       /* Digital Active - eth[0].rxd[0] */
    ...
    P19_3_ETH0_RXD1                 = 11,       /* Digital Active - eth[0].rxd[1] */
    ...
    P19_4_ETH0_RX_CLK               = 11,       /* Digital Active - eth[0].rx_clk */
    ...
    P19_5_ETH0_RXD2                 = 11,       /* Digital Active - eth[0].rxd[2] */
    P19_5_SMIF0_SMIF1_SPIHB_SELECT1 = 27        /* Digital Active - smif[0].smif1_spihb_select1 */
} en_hsiom_sel_t;

#endif /* _GPIO_TVIIC2D6MDDR_500_BGA_H_ */
