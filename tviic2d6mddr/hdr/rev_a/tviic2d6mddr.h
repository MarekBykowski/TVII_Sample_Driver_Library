...
#ifndef _TVIIC2D6MDDR_H_
#define _TVIIC2D6MDDR_H_

/**
* \addtogroup group_device TVIIC2D6MDDR
* \{
*/
...
/* TVIIC2D6MDDR peripheral interrupts */
typedef enum {
  ...
  ioss_interrupts_gpio_act_20_IRQn  =  62,      /*!<  62 [Active] GPIO Port Interrupt #20 */
...
#include "system_tviic2d6mddr.h"                /*!< TVIIC2D6MDDR System */
...
#include "tviic2d6mddr_config.h"
#include "gpio_tviic2d6mddr_500_bga.h"

#define CY_DEVICE_TVIIC2D6MDDR
#define CY_SILICON_ID                   0x00000000UL
...
#define PERI_MS_PPU_FX_HSIOM_PRT20_PRT          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[300])          /* 0x40025300 */
#define PERI_MS_PPU_FX_HSIOM_AMUX               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[301])          /* 0x40025340 */
#define PERI_MS_PPU_FX_HSIOM_MON                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[302])          /* 0x40025380 */
#define PERI_MS_PPU_FX_GPIO_PRT0_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[303])          /* 0x400253C0 */
#define PERI_MS_PPU_FX_GPIO_PRT1_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[304])          /* 0x40025400 */
#define PERI_MS_PPU_FX_GPIO_PRT2_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[305])          /* 0x40025440 */
#define PERI_MS_PPU_FX_GPIO_PRT3_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[306])          /* 0x40025480 */
#define PERI_MS_PPU_FX_GPIO_PRT4_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[307])          /* 0x400254C0 */
#define PERI_MS_PPU_FX_GPIO_PRT5_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[308])          /* 0x40025500 */
#define PERI_MS_PPU_FX_GPIO_PRT6_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[309])          /* 0x40025540 */
#define PERI_MS_PPU_FX_GPIO_PRT7_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[310])          /* 0x40025580 */
#define PERI_MS_PPU_FX_GPIO_PRT8_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[311])          /* 0x400255C0 */
#define PERI_MS_PPU_FX_GPIO_PRT9_PRT            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[312])          /* 0x40025600 */
#define PERI_MS_PPU_FX_GPIO_PRT10_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[313])          /* 0x40025640 */
#define PERI_MS_PPU_FX_GPIO_PRT11_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[314])          /* 0x40025680 */
#define PERI_MS_PPU_FX_GPIO_PRT12_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[315])          /* 0x400256C0 */
#define PERI_MS_PPU_FX_GPIO_PRT13_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[316])          /* 0x40025700 */
#define PERI_MS_PPU_FX_GPIO_PRT14_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[317])          /* 0x40025740 */
#define PERI_MS_PPU_FX_GPIO_PRT15_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[318])          /* 0x40025780 */
#define PERI_MS_PPU_FX_GPIO_PRT16_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[319])          /* 0x400257C0 */
#define PERI_MS_PPU_FX_GPIO_PRT17_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[320])          /* 0x40025800 */
#define PERI_MS_PPU_FX_GPIO_PRT18_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[321])          /* 0x40025840 */
#define PERI_MS_PPU_FX_GPIO_PRT19_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[322])          /* 0x40025880 */
#define PERI_MS_PPU_FX_GPIO_PRT20_PRT           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[323])          /* 0x400258C0 */
...
#define PERI_MS_PPU_FX_GPIO_GPIO                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[345])          /* 0x40025E40 */
#define PERI_MS_PPU_FX_GPIO_TEST                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[346])          /* 0x40025E80 */
#define PERI_MS_PPU_FX_SMARTIO_PRT8_PRT         ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[347])          /* 0x40025EC0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT0_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[348])          /* 0x40025F00 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT1_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[349])          /* 0x40025F40 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT2_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[350])          /* 0x40025F80 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT3_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[351])          /* 0x40025FC0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT4_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[352])          /* 0x40026000 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT5_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[353])          /* 0x40026040 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT6_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[354])          /* 0x40026080 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT7_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[355])          /* 0x400260C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT8_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[356])          /* 0x40026100 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT9_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[357])          /* 0x40026140 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT10_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[358])          /* 0x40026180 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT11_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[359])          /* 0x400261C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT12_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[360])          /* 0x40026200 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT13_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[361])          /* 0x40026240 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT14_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[362])          /* 0x40026280 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT15_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[363])          /* 0x400262C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT16_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[364])          /* 0x40026300 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT17_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[365])          /* 0x40026340 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT18_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[366])          /* 0x40026380 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT19_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[367])          /* 0x400263C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT20_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[368])          /* 0x40026400 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT21_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[369])          /* 0x40026440 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT22_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[370])          /* 0x40026480 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT23_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[371])          /* 0x400264C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT24_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[372])          /* 0x40026500 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT25_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[373])          /* 0x40026540 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT26_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[374])          /* 0x40026580 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT27_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[375])          /* 0x400265C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT28_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[376])          /* 0x40026600 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT29_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[377])          /* 0x40026640 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT30_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[378])          /* 0x40026680 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT31_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[379])          /* 0x400266C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT32_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[380])          /* 0x40026700 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT33_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[381])          /* 0x40026740 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT34_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[382])          /* 0x40026780 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT35_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[383])          /* 0x400267C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT36_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[384])          /* 0x40026800 */
#define PERI_MS_PPU_FX_TCPWM0_GRP0_CNT37_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[385])          /* 0x40026840 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT0_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[386])          /* 0x40026880 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT1_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[387])          /* 0x400268C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT2_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[388])          /* 0x40026900 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT3_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[389])          /* 0x40026940 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT4_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[390])          /* 0x40026980 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT5_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[391])          /* 0x400269C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT6_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[392])          /* 0x40026A00 */
#define PERI_MS_PPU_FX_TCPWM0_GRP1_CNT7_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[393])          /* 0x40026A40 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT0_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[394])          /* 0x40026A80 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT1_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[395])          /* 0x40026AC0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT2_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[396])          /* 0x40026B00 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT3_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[397])          /* 0x40026B40 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT4_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[398])          /* 0x40026B80 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT5_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[399])          /* 0x40026BC0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT6_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[400])          /* 0x40026C00 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT7_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[401])          /* 0x40026C40 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT8_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[402])          /* 0x40026C80 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT9_CNT     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[403])          /* 0x40026CC0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT10_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[404])          /* 0x40026D00 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT11_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[405])          /* 0x40026D40 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT12_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[406])          /* 0x40026D80 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT13_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[407])          /* 0x40026DC0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT14_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[408])          /* 0x40026E00 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT15_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[409])          /* 0x40026E40 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT16_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[410])          /* 0x40026E80 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT17_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[411])          /* 0x40026EC0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT18_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[412])          /* 0x40026F00 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT19_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[413])          /* 0x40026F40 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT20_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[414])          /* 0x40026F80 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT21_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[415])          /* 0x40026FC0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT22_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[416])          /* 0x40027000 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT23_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[417])          /* 0x40027040 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT24_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[418])          /* 0x40027080 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT25_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[419])          /* 0x400270C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT26_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[420])          /* 0x40027100 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT27_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[421])          /* 0x40027140 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT28_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[422])          /* 0x40027180 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT29_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[423])          /* 0x400271C0 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT30_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[424])          /* 0x40027200 */
#define PERI_MS_PPU_FX_TCPWM0_GRP2_CNT31_CNT    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[425])          /* 0x40027240 */
#define PERI_MS_PPU_FX_EVTGEN0                  ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[426])          /* 0x40027280 */
#define PERI_MS_PPU_FX_SMIF0_MAIN               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[427])          /* 0x400272C0 */
#define PERI_MS_PPU_FX_SDHC0                    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[428])          /* 0x40027300 */
#define PERI_MS_PPU_FX_ETH0                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[429])          /* 0x40027340 */
#define PERI_MS_PPU_FX_LPDDR40_LPDDR4_WRAPPER_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[430])       /* 0x40027380 */
#define PERI_MS_PPU_FX_LPDDR40_LPDDR4_WRAPPER_BOOT ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[431])       /* 0x400273C0 */
#define PERI_MS_PPU_FX_LPDDR40_AXI_PERF_CNT_MAIN ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[432])         /* 0x40027400 */
#define PERI_MS_PPU_FX_LPDDR40_LPDDR4_CORE_3PIP ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[433])          /* 0x40027440 */
#define PERI_MS_PPU_FX_LIN0_MAIN                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[434])          /* 0x40027480 */
#define PERI_MS_PPU_FX_LIN0_CH0_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[435])          /* 0x400274C0 */
#define PERI_MS_PPU_FX_LIN0_CH1_CH              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[436])          /* 0x40027500 */
#define PERI_MS_PPU_FX_CXPI0_MAIN               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[437])          /* 0x40027540 */
#define PERI_MS_PPU_FX_CXPI0_CH0_CH             ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[438])          /* 0x40027580 */
#define PERI_MS_PPU_FX_CXPI0_CH1_CH             ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[439])          /* 0x400275C0 */
#define PERI_MS_PPU_FX_CANFD0_CH0_CH            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[440])          /* 0x40027600 */
#define PERI_MS_PPU_FX_CANFD0_CH1_CH            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[441])          /* 0x40027640 */
#define PERI_MS_PPU_FX_CANFD1_CH0_CH            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[442])          /* 0x40027680 */
#define PERI_MS_PPU_FX_CANFD1_CH1_CH            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[443])          /* 0x400276C0 */
#define PERI_MS_PPU_FX_CANFD0_MAIN              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[444])          /* 0x40027700 */
#define PERI_MS_PPU_FX_CANFD1_MAIN              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[445])          /* 0x40027740 */
#define PERI_MS_PPU_FX_CANFD0_BUF               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[446])          /* 0x40027780 */
#define PERI_MS_PPU_FX_CANFD1_BUF               ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[447])          /* 0x400277C0 */
#define PERI_MS_PPU_FX_SCB0                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[448])          /* 0x40027800 */
#define PERI_MS_PPU_FX_SCB1                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[449])          /* 0x40027840 */
#define PERI_MS_PPU_FX_SCB2                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[450])          /* 0x40027880 */
#define PERI_MS_PPU_FX_SCB3                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[451])          /* 0x400278C0 */
#define PERI_MS_PPU_FX_SCB4                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[452])          /* 0x40027900 */
#define PERI_MS_PPU_FX_SCB5                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[453])          /* 0x40027940 */
#define PERI_MS_PPU_FX_SCB6                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[454])          /* 0x40027980 */
#define PERI_MS_PPU_FX_SCB7                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[455])          /* 0x400279C0 */
#define PERI_MS_PPU_FX_SCB8                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[456])          /* 0x40027A00 */
#define PERI_MS_PPU_FX_SCB9                     ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[457])          /* 0x40027A40 */
#define PERI_MS_PPU_FX_SCB10                    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[458])          /* 0x40027A80 */
#define PERI_MS_PPU_FX_SCB11                    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[459])          /* 0x40027AC0 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT0_TDM_TX_STRUCT_TX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[460]) /* 0x40027B00 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT1_TDM_TX_STRUCT_TX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[461]) /* 0x40027B40 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT2_TDM_TX_STRUCT_TX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[462]) /* 0x40027B80 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT3_TDM_TX_STRUCT_TX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[463]) /* 0x40027BC0 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT0_TDM_RX_STRUCT_RX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[464]) /* 0x40027C00 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT1_TDM_RX_STRUCT_RX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[465]) /* 0x40027C40 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT2_TDM_RX_STRUCT_RX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[466]) /* 0x40027C80 */
#define PERI_MS_PPU_FX_TDM0_TDM_STRUCT3_TDM_RX_STRUCT_RX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[467]) /* 0x40027CC0 */
#define PERI_MS_PPU_FX_SG0_SG_STRUCT0_TX        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[468])          /* 0x40027D00 */
#define PERI_MS_PPU_FX_SG0_SG_STRUCT1_TX        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[469])          /* 0x40027D40 */
#define PERI_MS_PPU_FX_SG0_SG_STRUCT2_TX        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[470])          /* 0x40027D80 */
#define PERI_MS_PPU_FX_SG0_SG_STRUCT3_TX        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[471])          /* 0x40027DC0 */
#define PERI_MS_PPU_FX_SG0_SG_STRUCT4_TX        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[472])          /* 0x40027E00 */
#define PERI_MS_PPU_FX_PWM0_MAIN                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[473])          /* 0x40027E40 */
#define PERI_MS_PPU_FX_PWM0_TX0_TX              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[474])          /* 0x40027E80 */
#define PERI_MS_PPU_FX_PWM0_TX1_TX              ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[475])          /* 0x40027EC0 */
#define PERI_MS_PPU_FX_DAC0_MAIN                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[476])          /* 0x40027F00 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_SRC_STRUCT0_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[477])      /* 0x40027F40 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_SRC_STRUCT1_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[478])      /* 0x40027F80 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_SRC_STRUCT2_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[479])      /* 0x40027FC0 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_SRC_STRUCT3_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[480])      /* 0x40028000 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_SRC_STRUCT4_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[481])      /* 0x40028040 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_SRC_STRUCT0_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[482])      /* 0x40028080 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_SRC_STRUCT1_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[483])      /* 0x400280C0 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_SRC_STRUCT2_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[484])      /* 0x40028100 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_SRC_STRUCT3_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[485])      /* 0x40028140 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_SRC_STRUCT4_SRC ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[486])      /* 0x40028180 */
#define PERI_MS_PPU_FX_MIXER0_MIXER_DST_STRUCT_DST ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[487])       /* 0x400281C0 */
#define PERI_MS_PPU_FX_MIXER1_MIXER_DST_STRUCT_DST ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[488])       /* 0x40028200 */
#define PERI_MS_PPU_FX_PASS0_SAR0_SAR           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[489])          /* 0x40028240 */
#define PERI_MS_PPU_FX_PASS0_SAR1_SAR           ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[490])          /* 0x40028280 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH0_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[491])          /* 0x400282C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH1_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[492])          /* 0x40028300 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH2_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[493])          /* 0x40028340 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH3_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[494])          /* 0x40028380 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH4_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[495])          /* 0x400283C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH5_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[496])          /* 0x40028400 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH6_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[497])          /* 0x40028440 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH7_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[498])          /* 0x40028480 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH8_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[499])          /* 0x400284C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH9_CH        ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[500])          /* 0x40028500 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH10_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[501])          /* 0x40028540 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH11_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[502])          /* 0x40028580 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH12_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[503])          /* 0x400285C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH13_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[504])          /* 0x40028600 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH14_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[505])          /* 0x40028640 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH15_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[506])          /* 0x40028680 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH16_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[507])          /* 0x400286C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH17_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[508])          /* 0x40028700 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH18_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[509])          /* 0x40028740 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH19_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[510])          /* 0x40028780 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH20_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[511])          /* 0x400287C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH21_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[512])          /* 0x40028800 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH22_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[513])          /* 0x40028840 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH23_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[514])          /* 0x40028880 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH24_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[515])          /* 0x400288C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH25_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[516])          /* 0x40028900 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH26_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[517])          /* 0x40028940 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH27_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[518])          /* 0x40028980 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH28_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[519])          /* 0x400289C0 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH29_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[520])          /* 0x40028A00 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH30_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[521])          /* 0x40028A40 */
#define PERI_MS_PPU_FX_PASS0_SAR0_CH31_CH       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[522])          /* 0x40028A80 */
#define PERI_MS_PPU_FX_PASS0_TOP                ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[523])          /* 0x40028AC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_VCFG_VIDEOSSCFG ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[524])          /* 0x40028B00 */
#define PERI_MS_PPU_FX_VIDEOSS0_VCFG_GFXCACHEPIX ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[525])         /* 0x40028B40 */
#define PERI_MS_PPU_FX_VIDEOSS0_VCFG_GFXCACHECMD ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[526])         /* 0x40028B80 */
#define PERI_MS_PPU_FX_VIDEOSS0_VCFG_LBCBARBLIT ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[527])          /* 0x40028BC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_GPU_GFX2D       ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[528])          /* 0x40028C00 */
#define PERI_MS_PPU_FX_VIDEOSS0_VIDEOIOCFG_VIRQ_VIDEOIOCFG ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[529]) /* 0x40028C40 */
#define PERI_MS_PPU_FX_VIDEOSS0_CAPIFC0_FRAMEDUMP ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[530])        /* 0x40028C80 */
#define PERI_MS_PPU_FX_VIDEOSS0_CAPIFC0_CAPENG0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[531])          /* 0x40028CC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCFG_COMPENGCFG ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[532])        /* 0x40028D00 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPSEC0_CONSTFRAME0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[533])      /* 0x40028D40 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPSEC0_EXTDST0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[534])          /* 0x40028D80 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPPRIM0_CONSTFRAME4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[535])     /* 0x40028DC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPPRIM0_EXTDST4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[536])         /* 0x40028E00 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPSEC1_CONSTFRAME1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[537])      /* 0x40028E40 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPSEC1_EXTDST1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[538])          /* 0x40028E80 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPPRIM1_CONSTFRAME5 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[539])     /* 0x40028EC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPPRIM1_EXTDST5 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[540])         /* 0x40028F00 */
#define PERI_MS_PPU_FX_VIDEOSS0_CAPIFC0_EXTSRC4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[541])          /* 0x40028F40 */
#define PERI_MS_PPU_FX_VIDEOSS0_CAPIFC0_STORE4  ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[542])          /* 0x40028F80 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER1_FETCHLAYER0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[543])    /* 0x40028FC0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER2_FETCHDECODE4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[544])   /* 0x40029000 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER2_FETCHECO4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[545])      /* 0x40029040 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER3_FETCHWARP1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[546])     /* 0x40029080 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER3_FETCHECO1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[547])      /* 0x400290C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER4_FETCHLAYER1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[548])    /* 0x40029100 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPLAYER5_FETCHDECODE0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[549])   /* 0x40029140 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPVPB_GAMMACOR4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[550])         /* 0x40029180 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPVPB_MATRIX4  ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[551])          /* 0x400291C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPVPB_GPSCALER4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[552])         /* 0x40029200 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPVPB_HISTOGRAM4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[553])        /* 0x40029240 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPBLEND1_LAYERBLEND1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[554])    /* 0x40029280 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPBLEND2_LAYERBLEND2 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[555])    /* 0x400292C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPBLEND3_LAYERBLEND3 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[556])    /* 0x40029300 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPBLEND4_LAYERBLEND4 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[557])    /* 0x40029340 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPBLEND5_LAYERBLEND5 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[558])    /* 0x40029380 */
#define PERI_MS_PPU_FX_VIDEOSS0_CAPIFC0_EXTSRC8 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[559])          /* 0x400293C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCFG0_DISENGCFG0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[560])       /* 0x40029400 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPMON0_SIG0    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[561])          /* 0x40029440 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPMON0_HISTOGRAM0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[562])       /* 0x40029480 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL0_GAMMACOR20 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[563])       /* 0x400294C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL0_MATRIX0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[564])          /* 0x40029500 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCFG0_FRAMEGEN0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[565])        /* 0x40029540 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL0_GAMMACOR0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[566])        /* 0x40029580 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL0_DITHER0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[567])          /* 0x400295C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPIFC0_TCON0   ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[568])          /* 0x40029600 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCFG1_DISENGCFG1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[569])       /* 0x40029640 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPMON1_SIG1    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[570])          /* 0x40029680 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPMON1_HISTOGRAM1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[571])       /* 0x400296C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL1_GAMMACOR21 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[572])       /* 0x40029700 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL1_MATRIX1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[573])          /* 0x40029740 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCFG1_FRAMEGEN1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[574])        /* 0x40029780 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL1_GAMMACOR1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[575])        /* 0x400297C0 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPCOL1_DITHER1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[576])          /* 0x40029800 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPIFC1_TCON1   ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[577])          /* 0x40029840 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPIFC0_FPDLINK0 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[578])         /* 0x40029880 */
#define PERI_MS_PPU_FX_VIDEOSS0_DSPIFC1_FPDLINK1 ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[579])         /* 0x400298C0 */
...
#define PERI_MS_PPU_FX_VIDEOSS0_MAIN            ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[582])          /* 0x40029980 */
#define PERI_MS_PPU_FX_PD_PD                    ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[583])          /* 0x400299C0 */
#define PERI_MS_PPU_FX_JPEGDEC_JPEGDEC          ((volatile stc_PERI_MS_PPU_FX_t*) &PERI_MS->PPU_FX[584])          /* 0x40029A00 */
...
#define VIDEOSS0_INFRA0_GFX_MPU_RD              ((volatile stc_VIDEOSS_INFRA_GFX_MPU_RD_t*) &VIDEOSS0->INFRA[0].GFX_MPU_RD) /* 0x40AF4000 */
#define VIDEOSS0_INFRA0_GFX_MPU_WR              ((volatile stc_VIDEOSS_INFRA_GFX_MPU_WR_t*) &VIDEOSS0->INFRA[0].GFX_MPU_WR) /* 0x40AF8000 */
