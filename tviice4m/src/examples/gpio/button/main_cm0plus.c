...
#define USER_BUTTON_PORT        CY_BSP_BB_USER_BUTTON1_PORT
#define USER_BUTTON_PIN         CY_BSP_BB_USER_BUTTON1_PIN
#define USER_BUTTON_PIN_MUX     CY_BSP_BB_USER_BUTTON1_PIN_MUX
#define USER_BUTTON_IRQ         CY_BSP_BB_USER_BUTTON1_IRQN
