                             ...
                             cy_en_power_mode_t                 mode)
{
    ...
    {
        un_srom_api_args_t *contest;
	
        cy_stc_configure_regulator2_arg_t configRegArgs =
        {
            contest->ConfigureRegulator2.arg0.Mode                   = (cy_en_srom_regulator_mode_t)            mode,
            contest->ConfigureRegulator2.arg0.EnablePolarity         = (cy_en_srom_regulator_enable_polarity_t) enablePolarity,
            contest->ConfigureRegulator2.arg0.StatusAbnormalPolarity = (cy_en_srom_regulator_status_polarity_t) statusPolarity,
            contest->ConfigureRegulator2.arg0.DeepSleep              = 0,
            contest->ConfigureRegulator2.arg0.UseLinReg              = 0,
            contest->ConfigureRegulator2.arg0.UseRadj                = 0,/* Not used*/
            contest->ConfigureRegulator2.arg0.VadjOption             = 1,
            contest->ConfigureRegulator2.arg0.VoltageAdjust          = voltageAdjust,
            contest->ConfigureRegulator2.arg0.RAdjust                = 0, /* Not used*/
            contest->ConfigureRegulator2.arg0.Opcode                 = CY_SROM_OP_CONFIGURE_REGULATOR,
	        contest->ConfigureRegulator2.arg1.WaitCountIn1us         = 0x1FF,
        };		
