...
#ifndef _CYT4DNJAES_H_
#define _CYT4DNJAES_H_

/**
* \addtogroup group_device CYT4DNJAES
* \{
*/
...
/* CYT4DNJAES peripheral interrupts */
typedef enum {
