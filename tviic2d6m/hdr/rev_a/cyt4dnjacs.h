...
#ifndef _CYT4DNJACS_H_
#define _CYT4DNJACS_H_

/**
* \addtogroup group_device CYT4DNJACS
* \{
*/
...
/* CYT4DNJACS peripheral interrupts */
typedef enum {
