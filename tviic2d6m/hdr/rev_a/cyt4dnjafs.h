...
#ifndef _CYT4DNJAFS_H_
#define _CYT4DNJAFS_H_

/**
* \addtogroup group_device CYT4DNJAFS
* \{
*/
...
/* CYT4DNJAFS peripheral interrupts */
typedef enum {
