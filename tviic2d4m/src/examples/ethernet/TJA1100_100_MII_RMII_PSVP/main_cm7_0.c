...
#if EMAC_INTERFACE == EMAC_MII
    Cy_EthIf_PhyRegWrite(ETH_REG_BASE, 0x12u, 0x8810u, PHY_ADDR, CORE_FREQ_IN_MHZ); /* Register 18 Configuration register 1 master, MII */
#else
    Cy_EthIf_PhyRegWrite(ETH_REG_BASE, 0x12u, 0x8910u, PHY_ADDR, CORE_FREQ_IN_MHZ); /* Register 18 Configuration register 1 master, RMII 50MHz */
#endif
...
static bool Check_TJA1100_LinkStatus (void)
{
    ...
    {
        Cy_EthIf_WaitUsec(40000ul, CORE_FREQ_IN_MHZ);
