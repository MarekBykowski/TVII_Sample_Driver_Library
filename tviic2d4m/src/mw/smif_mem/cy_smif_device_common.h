...
****************************************************************************//**
*
* This function converts \ref cy_en_smif_slave_select_t to slave No.
* If input value has multiple slave, it returns smallest one.
* e.g. if input value is b'1000, the function returns "3".
* e.g. if input value is b'1010, the function returns "1".
*
* \param slave (see \cy_en_smif_slave_select_t)
*
* \return
*  Slave No. if input value is invalid, it will return 0x00.
*
*******************************************************************************/
static uint8_t CY_SMIF_GetSlaveNo(volatile cy_stc_smif_reg_t *base, cy_en_smif_slave_select_t slave)
{
    uint8_t slaveTemp = (uint8_t)slave;
    uint8_t slaveNo = 0;
