...
#include "srom/cy_srom.h"
    ...
    #include "audioss/sg/cy_sg.h"
        ...
        #include "audioss/i2s_rev_a/cy_i2s.h"
        #include "smif/ver3_0/cy_smif_ver_specific.h"
        #include "smif/common/cy_smif_memslot.h"
...
#if defined (tviic2d4m) || defined (tviice4m) || (defined (tviic2d6m) && defined (CY_MCU_rev_b))
