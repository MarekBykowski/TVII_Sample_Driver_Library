...
#if defined (tviibe1m) || defined (tviibh8m) || defined (tviibe2m) || defined (tviibe4m) || defined (tviibh4m)
    { 
        CY_CANFD0_2_TYPE,   /* channel */
        { NULL }            /* context */
    },
#endif
#if defined (tviibh8m) || defined (tviibe2m) || defined (tviibe4m) || defined (tviibh4m)
    { 
