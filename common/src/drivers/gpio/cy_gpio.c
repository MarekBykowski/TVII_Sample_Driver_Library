...
****************************************************************************//**
*
* \brief Initialize all pin configuration setting for multiple the pin.
*        This will return CY_GPIO_BAD_PARAM if only one of configuration
*        parameters has but parameter.
*
* \param config
