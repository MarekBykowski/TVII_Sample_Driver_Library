...
typedef struct
{
    cy_stc_configure_regulator2_args_t      arg0;
    cy_stc_configure_regulator2_args_2_t    arg1;
    uint32_t resv[2];
} cy_stc_configure_regulator2_arg_t;
/************************************/
...
typedef union
{
    ...
    cy_stc_configure_regulator2_arg_t       ConfigureRegulator2;
